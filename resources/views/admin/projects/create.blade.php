...
<div class="card">
    <form action="{{ route('admin.projects.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input type="text" name="title" required value="{{ old('title') }}" placeholder="Contoh: E-Commerce Website">
            @error('title')
        ...
        <div class="form-group">
            ...
            <textarea name="description" required rows="4" placeholder="Deskripsikan project ini...">{{ old('description') }}</textarea>
            @error('description')
                <small style="color: red;">{{ $message }}</small>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="technologies" required value="{{ old('technologies') }}" placeholder="Contoh: Laravel, MySQL, Bootstrap">
        ...
        <div class="form-group">
            ...
            <input type="number" name="year" value="{{ old('year') }}" placeholder="2024" min="2000" max="2100">
            @error('year')
                <small style="color: red;">{{ $message }}</small>
            @enderror
        </div>
