    ...
    <div class="admin-container">
        ...
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="{{ route('admin.skills.index') }}" class="{{ request()->routeIs('admin.skills.*') ? 'active' : '' }}">Skills</a></li>
                ...
                <li><a href="{{ route('admin.hobbies.index') }}" class="{{ request()->routeIs('admin.hobbies.*') || request()->routeIs('admin.hobby-items.*') ? 'active' : '' }}">Hobbies</a></li>
